...
| [CLUSTER.md](CLUSTER.md) | **Cluster mode** — config, on-disk layout, RPC quick reference, scheduler dedup, replication phases, **user store + authentication**, **LLM surface**, **relationship graph store (§ 11.4)** |
